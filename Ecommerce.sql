...
(6, 'Coffee Maker', 'Automatic coffee maker', 50.00, 25, 'Home Appliances'),
(7, 'Refrigerator', 'Energy-efficient', 700.00, 10, 'Home Appliances'),
(8, 'Microwave Oven', 'Countertop microwave', 80.00, 15, 'Home Appliances'),
(9, 'Blender', 'High-speed blender', 70.00, 20, 'Home Appliances'),
(10, 'Vacuum Cleaner', 'Bagless vacuum cleaner', 120.00, 10, 'Home Appliances');
...
select category, min(stock_quantity) as min_stock
from products
group by category;
